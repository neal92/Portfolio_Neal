...
export const projects = [
  {
    id: 'service-booking',
    title: {
      en: 'Saas Service Booking',
      fr: 'Réservation de service SaaS',
    },
    description: {
      en: 'A comprehensive service booking platform with real-time availability, user management, and advanced reporting capabilities.',
  ...
  // Ajoutez d'autres projets ici en suivant le même modèle
];
...
const Projects: React.FC<ProjectsProps> = ({ language }) => {
  const t = {
    en: {
      ...
      desc: 'Innovative solutions that demonstrate technical excellence and creative problem-solving',
      code: 'Code',
      demo: 'Demo',
    },
    fr: {
      ...
      desc: 'Des solutions innovantes qui démontrent l’excellence technique et la créativité',
      code: 'Code',
      demo: 'Démo',
    },
  };
