        ...
        <div className="animate-fade-in-up space-y-8">
          <div className="inline-block p-1 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full mb-6">
            <div className="bg-slate-900 px-6 py-2 rounded-full">
              <span className="text-sm font-medium text-blue-300">{t[language].available}</span>
            </div>
          </div>
          ...
          <p className="text-2xl sm:text-3xl lg:text-4xl text-slate-200 mb-6 font-light">
            {t[language].role}
          </p>
          <p className="text-xl sm:text-2xl text-slate-300 mb-16 max-w-3xl mx-auto leading-relaxed font-light">
            {t[language].description}
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <button
              onClick={() => onNavigate('projects')}
              className="group relative bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-10 py-5 rounded-2xl font-semibold text-lg transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25"
            >
            ...
            <button
              ...
              className="group relative border-2 border-white/30 text-white hover:bg-white hover:text-slate-900 px-10 py-5 rounded-2xl font-semibold text-lg transition-all duration-500 transform hover:scale-105 backdrop-blur-sm"
            >
              <span className="relative">
